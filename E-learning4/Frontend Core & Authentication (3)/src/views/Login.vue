  ...
  <div class="min-h-screen bg-gradient-to-br from-amber-50 to-pink-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md border border-amber-100">
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-amber-900">Đăng nhập</h1>
        <p class="text-amber-600 mt-2">Chào mừng trở lại! Vui lòng đăng nhập vào tài khoản của bạn.</p>
      </div>
      ...
      <form @submit.prevent="handleLogin" class="space-y-6">
        ...
        <div class="text-center">
          <p class="text-amber-600">
            Chưa có tài khoản?
            <router-link to="/register" class="text-amber-700 hover:text-amber-800 font-medium ml-1 underline">
              Đăng ký
            </router-link>
          </p>
        </div>
